...
class CryptoUtils(object):
    ...
    @staticmethod
    def create_mnemonic_key(key):
        """
        Generates words then seed based on the supplied key
        :param key: <str>
        :return: <<str>, <str>>
        """
        try:
            ...
            seed = mnemonic.to_seed(words, passphrase=key)
            return words, str(seed)
        except Exception as e:
            print("Seed could not be generated. " + str(e))